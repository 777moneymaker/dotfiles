...
export ZSH="/Users/miles/.oh-my-zsh"
...
plugins=(git sudo zsh-syntax-highlighting web-search copydir copyfile copybuffer history macos zsh-autosuggestions)
...
__conda_setup="$('/Users/miles/opt/anaconda3/bin/conda' 'shell.zsh' 'hook' 2> /dev/null)"
if [ $? -eq 0 ]; then
    eval "$__conda_setup"
else
